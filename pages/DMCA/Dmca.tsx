      ...
      <div style={styles.dmcaContainer}>
        <div style={styles.dmcaContent}>
          ...
          <Typography variant="body1" style={styles.text}>
            The owners and operators of novapornx.com are not the producers (as that term is defined in 18 U.S.C. Section 2257) of any of the visual content contained in the site.
            <br />
            <br />
            The owners and operators of novapornx.com are not U.S. citizens. novapornx.com doesn’t host any content.
            <br />
            <br />
            All novapornx.com does is use link or embed content that was uploaded to popular Online Video hosting. All popular Online Video hosting users signed a contract with the sites when they set up their accounts which force them not to upload illegal content. By clicking on any Links to videos while surfing on novapornx.com you watch content hosted on third parties and novapornx.com can’t take the responsibility for any content hosted on other sites.
            <br />
            <br />
